...
namespace Greenspot.Stall
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext(GreenspotIdentityDbContext.Create);
            ...
            app.UseCookieAuthentication(new CookieAuthenticationOptions
            {
                ...
                Provider = new CookieAuthenticationProvider
                {
                    ...
                    OnValidateIdentity = SecurityStampValidator.OnValidateIdentity<GreenspotUserManager, GreenspotUser>(
            ...
            app.UseWeChatAuthentication(new WeChatAuthenticationOptions(GreenspotConfiguration.AccessAccounts["wechat"].Id,
                GreenspotConfiguration.AccessAccounts["wechat"].Secret, ApplicationTypes.MP, ScopeTypes.Base, false, true)
            {
